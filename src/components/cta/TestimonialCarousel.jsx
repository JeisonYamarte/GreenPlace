...
export default function TestimonialCarousel() {
  ...
  return (
    <div className="relative w-full h-full max-h-[70svh] flex items-center justify-center overflow-hidden md:flex-col">
      ...
      <Marquee pauseOnHover={true} vertical={isSmallScreen} className="max-h-[70svh] font-semibold text-lg [--duration:120s]" repeat={3}>
        {reviews1.map((review, index) => (
          <SocialCard key={index} body={review.text} name={review.author} img={review.img} />
        ))}
      </Marquee>
      <Marquee pauseOnHover={true} vertical={isSmallScreen} className="max-h-[70svh] font-semibold text-lg [--duration:120s]" repeat={3} reverse>
      ...
      {/* Sombras para fade */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[#FCF9EA] to-60% to-transparent z-10" />
