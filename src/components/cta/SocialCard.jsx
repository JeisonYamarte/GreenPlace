export function SocialCard({ body, name, img }) {
  return (
    <figure className="relative flex flex-col gap-3 bg-[#F2D57E] w-44 p-4 cursor-pointer overflow-hidden rounded-2xl border border-gray-950/10 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300 md:w-72 lg:w-80">
