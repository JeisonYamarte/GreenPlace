  ...
  return (
    <div className="relative w-full mx-auto h-full overflow-hidden ">
      ...
      <div className="absolute w-[95%] flex flex-col items-center top-[35%] left-1/2 transform -translate-x-1/2 text-center text-white z-10">
        ...
        <h1 className="text-4xl font-bold mb-4 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] w-full">Creamos lo que amas</h1>
        <p className="text-lg mb-6 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">Productos de crochet hechos a mano con amor y dedicación</p>
      </div>
    </div>
  )
}
